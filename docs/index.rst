...
`MACE` is a a machine learning software for predicting many-body atomic interactions and generating force fields. It utilizes high r order equivariant message passing for fast and accurate predictions.
