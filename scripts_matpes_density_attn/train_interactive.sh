...
interaction_first="RALRIntBlock"
interaction="RALRResIntBlock"
model="ScaleShiftLRMACE"


#interaction="RADensityNFResidualIntBlock"
#interaction_first="RADensityNFIntBlock"
...
# Running code
bash run_multihead_5arg_dev.sh ${bs} ${lr} ${gpu} ${conf} ${r} ${num_channel} ${num_radial} ${mlp_irreps} ${seed} ${stress} ${interaction_first} ${interaction} ${num_interactions} ${agnostic_first} ${max_L} ${max_ell} ${contraction} ${model}
