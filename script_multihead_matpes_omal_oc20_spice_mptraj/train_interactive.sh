...
lr=0.005
gpu=16
conf=jz_matpes_spice_omol_oc20_r6.0.yaml
r=6.0
...
dir=matpes_omal_oc20_spice_no_mp
...
# Running code
bash run_multihead_5arg.sh ${bs} ${lr} ${gpu} ${conf} ${r} ${num_channel} ${num_radial} ${mlp_irreps} ${seed} ${stress} ${interaction_first} ${interaction} ${num_interactions} ${agnostic_first} ${max_L} ${max_ell} ${dir}
