...
def _reference_dielectric_predictions():
    ...
    ref_alphas = [
        ...
        np.array(
            [
                [-0.01774253, 0.00307792, 0.01980522],
        ...
        np.array(
            [
                [-0.10119078, -0.13912649, -0.06179769],
        ...
        np.array(
            [
                [-0.08015337, 0.28906984, -0.05851742],
        ...
        np.array(
            [
                [-0.10977471, -0.04570234, 0.28398318],
        ...
        np.array(
            [
                [-0.00033354, 0.00791392, 0.01818803],
        ...
        np.array(
            [
                [0.1590121, -0.0117003, 0.02571063],
        ...
        np.array(
            [
                [-0.14361682, -0.02639792, -0.04795591],
        ...
        np.array(
            [
                [-0.02385325, 0.00278218, -0.00900929],
        ...
        np.array(
            [
                [0.19766853, -0.05722875, -0.15204635],
        ...
        np.array(
            [
                [-3.33497839e-02, 5.84507102e-03, 1.03779892e-02],
        ...
        np.array(
            [
                [-0.03121629, -0.00526901, 0.00280257],
        ...
        np.array(
            [
                [0.08495039, 0.20898154, 0.15077567],
        ...
        np.array(
            [
                [0.02664201, -0.01412724, 0.01773262],
        ...
        np.array(
            [
                [-0.02283877, -0.00013611, -0.01089784],
        ...
        np.array(
            [
                [0.02721329, -0.0434384, 0.00925382],
        ...
        np.array(
            [
                [0.13941369, 0.1125973, 0.0079224],
        ...
        np.array(
            [
                [-0.00891008, 0.00219625, -0.00342596],
        ...
        np.array(
            [
                [-0.00305826, 0.03268619, -0.00097526],
        ...
        np.array(
            [
                [-0.0152999, -0.01413736, 0.01099587],
        ...
        np.array(
            [
                [-0.11326049, 0.00939965, -0.00715356],
...
@pytest.mark.xfail(
    reason="Pre-existing from #1439: dipole equivariance check fails with "
    "|R*mu - mu(R*x)| ~ 6.2e-2 for both parametrizations, reproduced on "
    "pristine develop (0f3f828) with cuequivariance 0.10.0 on macOS arm64. "
    "This test never ran in the old CI (no job installed cueq for this file), "
    "so #1439 merged without ever executing it. Possibly cueq-version or "
    "platform sensitive — non-strict so an XPASS on ubuntu CI is visible.",
    strict=False,
)
