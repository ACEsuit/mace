...
python mace/cli/run_train.py \
    ...
    --checkpoints_dir checkpoints/${dir}_ft \
    --results_dir results/${dir}_ft \
    --atomic_energies_block "bias" \
    --foundation_model /lustre/fswork/projects/rech/gax/unh55hx/mace/script_multihead_final_from_omat/mace-omat-0-medium.model 
    #--clean_alex \
