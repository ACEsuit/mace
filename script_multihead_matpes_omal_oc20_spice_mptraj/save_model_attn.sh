...
mace_run_train \
    ...
    --checkpoints_dir checkpoints/matpes_omal_oc20_spice_no_mp \
    --contraction=${contraction} \
    --just_save_model \
    
    #--checkpoints_dir checkpoints/multi_matpes_spice_${int}_${contraction}_nobias \
    #--checkpoints_dir checkpoints/multi_matpes_spice_${int}_${contraction}_nobias \
    #--results_dir results/multi_mp_spice_${int}_${contraction}_nobias \
    #--scheduler CosineAnnealingWarmupLR \
    #--warmup_epochs 0.05 \
    #--warmup_factor 0.2 \
    #--cosine_min 1e-6 \
    
    #--checkpoints_dir checkpoints/matpes_density_attn_coslr_cutoff24 \
    #--num_cutoff_basis 24 \
