...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--start_stage_two","--start_swa", help="Epoch that stage two (swa) loss began. Plots dashed line on plot to indicate. If None then assumed tag not used in training.", default=None, type=int, required=False, dest="start_swa"
    ...
    parser.add_argument(
        "--keys", help="Comma-separated list of keys to plot.", default='rmse_e,rmse_f', type=str, required=False,
    )
