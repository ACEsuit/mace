...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--distill_weight",
        help="weight for site energy and node feats distillation",
        type=str,
        default="[1.0, 1.0]"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--eta_min", help="Type of scheduler", type=float, default=1e-6
    )
    parser.add_argument(
...
def build_preprocess_distill_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--train_file",
    ...
    parser.add_argument(
        "--device",
        help="Device to run calculaor",
        type=str,
        default='cuda',
    )
    parser.add_argument(
        "--calculator",
        help="the calculator to compute the discriptor (teacher)",
        type=str,
        default="mace_off",
        choices=["mace_mp", "mace_off",]
    )
    parser.add_argument(
        "--calculator_size",
        help="the calculator to compute the discriptor (teacher)",
