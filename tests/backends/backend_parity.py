"""Shared parity harness for accelerated tensor-product backends.

BackendTestBase builds a ScaleShiftMACE, converts it e3nn -> backend -> e3nn
and checks forward (energy/forces/stress) and backward (all parameter grads)
parity. Backend test classes (tests/backends/test_cueq.py, test_oeq.py)
inherit from it and provide the conversion functions and device fixture.
"""
