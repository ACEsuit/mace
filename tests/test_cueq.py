...
class TestCueq:
    ...
    def batch(self, device: str):
        ...
        data_loader = torch_geometric.dataloader.DataLoader(
            dataset=[data.AtomicData.from_config(config, z_table=table, cutoff=5.0) 
    ...
    def test_cueq_equivalence(self, model_config: Dict[str, Any], batch: Dict[str, torch.Tensor], device: str):
