...
class LMDBDataset(Dataset):
    def __init__(self, file_path, r_max, z_table, dtype: Optional[torch.dtype] = None, **kwargs):
        ...
        self.AseDB = AseDBDataset(config=dict(src=dataset_paths, dtype=dtype, **config_kwargs))
        self.r_max = r_max
