...
#: mace/cli/eval_configs.py:104. Not part of any name -- the prefix is an
...
#: mace/cli/eval_configs.py:426 -- atoms.info[prefix + "BO_contributions"] is
...
#
# mace/cli/eval_configs.py:407-409 writes
...
def unflatten_bec(value) -> np.ndarray:
    ...
    if arr.ndim != 2 or arr.shape[-1] != 9:
        raise ValueError(
            ...
            "mentions at mace/calculators/mace.py:815, which no channel here "
...
harness.register_alias(
    ...
    note=(
        ...
        "extxyz array (mace/cli/eval_configs.py:407-409); the channel is the "
...
# (mace/cli/eval_configs.py:295-327). Where it lands depends on
...
#    into atoms.info (mace/cli/eval_configs.py:404, from a (n_graphs, 3, 3)
...
#    (mace/cli/eval_configs.py:411-423), unlike the calculator, which renames
