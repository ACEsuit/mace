...
from tests.helpers import CUET_AVAILABLE, run_mace_train  # noqa: F401  # pylint: disable=unused-import

# NOTE: this file keeps its own fitting_configs / pretraining_configs fixtures
# (they add REF_dipoles / REF_polarizability, so they differ from the
# canonical ones in tests/conftest.py)
